    ...
    <section className="hero">
      <div className="hero__content">
        ...
        <h1 className="hero__title hero__title--desktop">
          Uzmi pauzu od kuvanja, <br />
          ugrabi <span>brz zalogaj</span>.
        </h1>
        <h1 className="hero__title hero__title--mobile">
          Najbolja hrana, <br />
          <span>na klik</span> od tebe.
        </h1>
        <p className="hero__subtitle hero__subtitle--desktop">
          Gozba na klik ti donosi širok izbor restorana i kuhinja direktno na
          tvoj prag uz samo par klikova.
        </p>
        <p className="hero__subtitle hero__subtitle--mobile">
          Naruči iz omiljenih restorana brzo i lako.
        </p>
        <div className="hero__actions">
          <Link to="/restaurants" className="hero__btn hero__btn--primary">
            Pregledaj restorane
          </Link>
